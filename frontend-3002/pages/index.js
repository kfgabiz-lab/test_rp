...
const SERVICES = [
  ...
  { name: 'Frontend A', url: 'http://localhost:3001/api/ping', port: 3001, accent: '#2196F3' },
  { name: 'Frontend B (Self)', url: 'http://localhost:3002/api/ping', port: 3002, accent: '#9C27B0' },
];
...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Courier New', monospace", padding: '48px 40px', background: '#0f0a1a', minHeight: '100vh', color: '#eee' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        <div style={{ marginBottom: '8px', color: '#9C27B0', fontSize: '13px' }}>FIREWALL TEST DASHBOARD</div>
        <h1 style={{ color: '#9C27B0', margin: '0 0 6px', fontSize: '26px' }}>Frontend B — Port 3002</h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px', color: '#666', fontSize: '13px' }}>
          ...
          <button
            ...
            disabled={checking}
            style={{
              marginLeft: 'auto', background: '#9C27B0', color: '#fff', border: 'none',
